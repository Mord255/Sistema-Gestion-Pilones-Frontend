...
export default {
    ...
    methods:{
        ...
        async ObtenerData(){
            const respuesta = await axios.get(this.API_URL+'/mostrarCuenta?id_usuarios_cuentas='+this.idUsuario)
        ...
        async ObtenerMeses(){
            const respuesta1 = await axios.get(this.API_URL+'/mostrarMeses')
        ...
        async ObtenerAnos(){
            ...
            const respuesta2 = await axios.get(this.API_URL+'/mostrarAnos')
        ...
        async ObtenerPilones(){
            ...
            const respuesta3 = await axios.get(this.API_URL+'/mostrarPilones')
        ...
        EnviarData(e){
            ...
            if (id_mes==''||id_ano==''||id_pilon==''||id_user==''||data_estado=='') {
                ...
                this.axios.post(this.API_URL+'/NuevoRegistroCuentas',data,config).then((response) => {
